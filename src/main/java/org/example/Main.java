...
public class Main {
    public static void main(String[] args) {
        ...
        Order order1 = new Order(Utilities.generateId(), "Customer1",product1 ,3, "PROCESSING", ZonedDateTime.now() );
        Order order2 = new Order(Utilities.generateId(), "Customer2",product2 ,7, "PROCESSING", ZonedDateTime.now() );
        Order order3 = new Order(Utilities.generateId(), "Customer3",product3 ,5, "PROCESSING", ZonedDateTime.now() );
        Order noProduct = new Order(Utilities.generateId(), "Customer3",product6 ,7, "PROCESSING", ZonedDateTime.now() );
